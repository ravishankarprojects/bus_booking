...
<h1 style='text-transform: uppercase;'><center> customer info</center></h1>
...
echo'<th scope="col">PHNO</th>';
echo'<th scope="col">ARRIVAL</th>';
echo'<th scope="col">ATIME</th>';
echo'<th scope="col">DEPARTURE</th>';
echo'<th scope="col">DTIME</th>';
echo'<th scope="col">ADDRESS</th>';
echo'<th scope="col">GENDER</th>';
echo'<th scope="col"> BOOKED CLASS</th>';
echo'<th scope="col">BOOKED SEATS</th>';
...
while( $row=mysqli_fetch_assoc($result)) {
  echo'<tbody>';
    ...
    echo '<td>'.$row['name'].'</td>';//call by db coloumn name
    echo '<td>'.$row['age'].'</td>';
